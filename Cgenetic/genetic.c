...
unsigned * gen(unsigned * solution, unsigned populationSize, double mutationRate, unsigned tournamentSize, unsigned elitism, unsigned generations, struct Instance * instance) {
